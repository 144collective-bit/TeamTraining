...
const ICONS: Record<string, React.ReactNode> = {
  ...
  settings: (
    <>
      ...
      <path d="M9 1.9v1.8M9 14.3v1.8M14.02 3.98l-1.27 1.27M5.25 12.75l-1.27 1.27M16.1 9h-1.8M3.7 9H1.9M14.02 14.02l-1.27-1.27M5.25 5.25 3.98 3.98" />
    </>
  ),
  person: (
    <>
      <circle cx="9" cy="6" r="2.9" />
      <path d="M3.2 15.5c0-2.6 2.6-4.3 5.8-4.3s5.8 1.7 5.8 4.3" />
    </>
  ),
  improve: (
    <>
      <path d="M3 13 7.2 8.6l2.7 2.4L14 6.2" />
      <path d="M11.3 6.2h3v3" />
    </>
  ),
  doc: (
    <>
